...
define(["dojo/_base/declare",
			...
			"dojo/text!./templates/widgets.html",
			"dojo/_base/lang",
			"dojo/aspect",
			"dojo/dnd/Source",
      ...
      "dijit/_editor/plugins/FullScreen",
		...
		function (declare, dom, query, domConstruct, WidgetBase, TemplatedMixin, WidgetsInTemplateMixin, template, lang,
			aspect, Source, BorderContainer, TabContainer, AccordionContainer, ContentPane) {
          ...
          // Disable button
			    ...
			    }, "disable-button").startup();

			 		// Create Label
          dom.byId("disable-button-label").innerHTML = "Disable&nbsp;";
			 					 		
 					// Set the title
          dom.byId("header-text").innerHTML = document.title;
          ...
          // ----------------------------------------------------
            ...
            $('.ui.radio.checkbox').checkbox();
		        ...
		        initMenuBar: function () {
		            var pMenuBar = new dijit.MenuBar({'class':'make-disabled'});
